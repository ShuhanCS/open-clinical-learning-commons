...
- Course status: all 13 module specifications and runnable packages are complete; the Week 3 and Week 6 checkpoint packages are runnable release candidates
