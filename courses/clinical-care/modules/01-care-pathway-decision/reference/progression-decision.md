...
- Gate result: `12 passed or passed with owned conditions; no failed gate`
- Progression: `continue with conditions`
- Module 02 permission: `permitted for curriculum construction`
- Decision owner: `APP-1 faculty owner with clinical phenotype and methods review roles`
...
| C06 | Retain synthetic noncausal and no-implementation boundary | APP-1 faculty owner | every release | claim audit and reviewer acknowledgment | efficacy causation real-site or implementation claim appears | open |

## Decision rationale

The decision, pathway, timing, outcome set, source identity, feasibility evidence, audiences, improvement options, and claim boundary are complete enough to begin phenotype and cohort construction. Progression remains conditional because full-source reproduction, six-site extension construction, patient and access measures, and named program review belong to later work.
