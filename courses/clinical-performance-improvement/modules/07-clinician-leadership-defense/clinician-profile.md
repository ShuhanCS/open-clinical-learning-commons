...
Joe Joseph, MD, SFHM, is the designated clinician of record for the APP-3 leadership block.

The course uses only dated public facts:
...
These sources identify the intended hospital medicine physician leader. This curriculum makes no claim about Dr. Joseph's current employer or title.

Before alpha, Dr. Joseph must confirm participation, schedule, session format, recording permission, and final biography wording. This construction record does not claim that he reviewed or delivered the current package.
