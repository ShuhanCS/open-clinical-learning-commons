...
Joe Joseph, MD, SFHM, is the designated clinician of record for the APP-5 leadership block.

The course uses only these dated public facts:
...
These sources identify the intended physician leader. This curriculum makes no claim about Dr. Joseph's current employer or title.

Before alpha, Dr. Joseph must confirm participation, schedule, session format, recording permission, accessibility needs, preparation materials, case wording, assessment role, and final biography wording. This construction record does not claim that he reviewed, endorsed, or delivered the current package.
