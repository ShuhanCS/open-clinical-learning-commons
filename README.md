...
- Status: The public preview has an all-courses home page and the original 77 roadmap module routes. DA-730 has all 13 concept-first modules and all three cumulative checkpoints as runnable release candidates. FND-1 now has all seven technical modules and all three cumulative checkpoints as runnable release candidates, ending in a protected 100-file final toolkit with a scored defense and explicit FND-2 handoff.
